...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
    ...
    || defined(__SYMBIAN32__) || defined(__INTEGRITY) || defined(ANDROID)                \
 ...
 */
CURL_EXTERN int
curl_formget(struct curl_httppost *form, void *arg, curl_formget_callback append);
/*
 * NAME curl_formfree()
 *
 * DESCRIPTION
 ...
 */
CURL_EXTERN char *
curl_easy_unescape(CURL *handle, const char *string, int length, int *outlength);
